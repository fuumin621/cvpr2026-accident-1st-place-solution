#!/usr/bin/env python3
"""Run exp200 (Qwen3-VL-235B-A22B-Instruct, TP=8) on the full test set. 8 x RTX PRO 6000."""
...
from exp200 import DEFAULT_CONFIG, Exp200Predictor, resolve_video  # noqa: E402

DATASET_ROOT = Path("/kaggle/input/accident")
OUT_CSV = Path("/kaggle/working/submission_exp200.csv")
SUB_COLS = ["path", "accident_time", "center_x", "center_y", "type"]


def main() -> None:
    OUT_CSV.parent.mkdir(parents=True, exist_ok=True)
    predictor = Exp200Predictor(config=dict(DEFAULT_CONFIG))
